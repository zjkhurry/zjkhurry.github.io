...
function initWordCloud() {
    ...
    function wordCloudConfig() {
        ...
        ['Soft Robotics', 3],
        ['battery free', 3],
        ['human machine interfaces', 3],
        ['Neuromorphic', 2],
        ['Wound Care', 2],
        ['Microfluidics', 2],
        ['Cardiovascular Health', 2],
        ['AR/VR', 2],
        ['intelligent soft sweat sensors', 2],
        ['simultaneous healthcare monitoring', 2],
        ['safety warning', 2],
        ['virtual reality', 2],
        ['skin electronics', 2],
        ['tactile sensing', 2],
        ['energy harvesting', 2],
        ['tattoo like epidermal electronics', 2],
        ['skin sensors', 2],
        ...
        ['internal organs', 1],
        ['skin interfaced multimodal sensing', 1],
        ['enhanced human machine interface', 1],
        ['closed loop drone control', 1],
        ['tactile feedback system', 1],
