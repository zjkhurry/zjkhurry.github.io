...
function initWordCloud() {
    ...
    var wordCloudConfig = {
        ...
        ['gold nanoparticles composite', 1],
        ['soft sweat activated batteries', 1],
        ['triboelectric nanogenerator tattoos enabled', 1],
        ['epidermal electronic technologies', 1],
        ['stretchable sweat activated battery', 1],
        ['continuous wireless sweat monitoring', 1],
        ['skin integrated electronics', 1],
        ['wireless skin electronics', 1],
        ['continuous physiological monitoring', 1],
        ['continuous sweat monitoring', 1],
        ['wearable electronics', 1],
        ['lactate monitoring', 1],
        ['wireless human machine interfaces', 1],
        ['robotic vr', 1],
        ['electronic skin', 1],
        ['flexible perovskite solar cells', 1],
        ['wireless format', 1],
        ['tattoo like epidermal electronics', 1],
        ['skin sensors', 1],
        ['garment integrated triboelectric nanogenerators', 1],
        ['miniaturized electromechanical devices', 1],
        ['deep tissue', 1]
        ],
        weightFactor: 10,
        effect: 'linerMap',
